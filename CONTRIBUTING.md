...
Thanks for helping improve **oihana/php-controllers**.

## Requirements

- **PHP 8.4+**
- **Composer**
- **ext-imagick** — required at runtime by the image controllers, and by the test suite.
- **Xdebug** or **PCOV** — only needed to measure test coverage (see below).

## Setup

```shell
git clone https://github.com/BcommeBois/oihana-php-controllers.git
cd oihana-php-controllers
composer install
```
